...
export const BIOMARKERS: Biomarker[] = [
  ...
  },
  {
    id: BiomarkerId.Glu,
    name: 'Glucose',
    aliases: ['Glucose', 'Blood glucose', 'Fasting glucose', 'Serum glucose'],
  ...
  },
  {
    ...
    description:
      'Measures the number of reticulocytes, immature red blood cells. Used to evaluate bone marrow function and diagnose anemia.',
    classification: BiomarkerClassification.Cell,
    categories: [BiomarkerCategory.BloodCellCounts],
    measurementUnit: '%',
    wikipedia: 'https://en.wikipedia.org/wiki/Reticulocyte',
  },
  {
    id: BiomarkerId.Hgb,
    name: 'Hemoglobin',
  ...
  },
  {
    id: BiomarkerId.PLT,
    name: 'Platelet Count',
    aliases: ['Platelets', 'Platelet count', 'Thrombocytes'],
    description:
  ...
  },
  {
    ...
    classification: BiomarkerClassification.Mineral,
  ...
  },
  {
    ...
    classification: BiomarkerClassification.Vitamin,
  ...
  },
  {
    ...
    measurementUnit: '',
    wikipedia: 'https://en.wikipedia.org/wiki/Liver_fibrosis',
  },
  {
  ...
  },
  {
    ...
    description:
      'Measures the level of CRP, a protein produced by the liver in response to inflammation. Used to detect and monitor infections and inflammatory conditions.',
    classification: BiomarkerClassification.Protein,
    categories: [BiomarkerCategory.Inflammation],
    measurementUnit: 'mg/L',
    wikipedia: 'https://en.wikipedia.org/wiki/C-reactive_protein',
  ...
  },
  {
    ...
    name: 'Phosphorus',
    description:
      'Measures the level of phosphorus (phosphate) in the blood, which is essential for bone health, energy production, and cell function.',
    classification: BiomarkerClassification.Mineral,
    categories: [BiomarkerCategory.Bone, BiomarkerCategory.VitaminsAndMinerals],
    measurementUnit: 'mg/dL',
    wikipedia: 'https://en.wikipedia.org/wiki/Phosphate',
  },
  {
    id: BiomarkerId.SCr,
  ...
  },
  {
    ...
    description:
      'Bilirubin is a waste product from the breakdown of red blood cells. The liver processes it; elevated levels can indicate liver or bile duct problems.',
    classification: BiomarkerClassification.Chemical,
    categories: [BiomarkerCategory.Liver],
    measurementUnit: 'mg/dL',
    wikipedia: 'https://en.wikipedia.org/wiki/Bilirubin',
  },
  {
    id: BiomarkerId.Cl,
    name: 'Chloride',
  ...
  },
  {
    ...
    name: 'Zinc',
    description:
      'Zinc is an essential mineral that supports immune function, wound healing, and DNA synthesis. Deficiency can affect growth and immunity.',
    classification: BiomarkerClassification.Mineral,
    categories: [BiomarkerCategory.VitaminsAndMinerals],
    measurementUnit: 'µg/dL',
